...
export const mockSkillProgress: SkillProgress[] = [
  { id: "sk-1", skill: "Product Strategy", level: 88, target: 100 },
  { id: "sk-2", skill: "Roadmapping & PRDs", level: 85, target: 100 },
  { id: "sk-3", skill: "User Research", level: 78, target: 90 },
  { id: "sk-4", skill: "Data & Metrics", level: 82, target: 95 },
]
...
export const mockRecentActivity: RecentActivity[] = [
  ...
  },
  {
    ...
    description: "Google — Senior Product Manager",
